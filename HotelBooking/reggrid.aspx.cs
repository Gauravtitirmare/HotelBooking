...
namespace HotelBooking
{
    public partial class reggrid : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            con.Open();
            //pass the query
            var query = ("UPDATE  Registration  SET  LastName = '" + t2.Text + "',Username='" + t3.Text + "',Gender='" + t10.Text + "',Email='" + t6.Text + "',PhoneNumber='" + t7.Text + "',Address='" + t8.Text + "',Languageknown='" + t11.Text + "'Where FirstName='" + t1.Text + "' ");
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            con.Open();
            //pass the query
            var query = "DELETE  Registration Where FirstName ='" + lbl.Text + "' ";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.ExecuteNonQuery();
            con.Close();
            getdata();
